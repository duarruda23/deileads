...
// ============================================================
// getBaseUrl — resolve the base URL invite links get published
// under. Shared by every route that mints a `/join/<token>` link
// (account invitations, admin account creation, Virgo seller
// invitations) so the host-resolution + allow-list logic below
