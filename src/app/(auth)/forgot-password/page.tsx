        ...
        <Card className="w-full max-w-md border-slate-800 bg-slate-900">
          <CardHeader className="items-center text-center">
            ...
            <CardDescription className="text-slate-400">
              ...
              <span className="text-white">{email}</span>, enviamos um link
              para criar uma senha nova. Olhe também a caixa de spam. O link
              vale por 1 hora.
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      <Card className="w-full max-w-md border-slate-800 bg-slate-900">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-xl text-white">Esqueci minha senha</CardTitle>
          <CardDescription className="text-slate-400">
