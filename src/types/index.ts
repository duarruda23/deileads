...
export interface Contact {
  ...
  company?: string;
  avatar_url?: string;
  /** 034: profiles.id of the vendor this lead belongs to. Drives
   *  access control (can_view_owner) — null means unowned/visible to
   *  the whole account. */
...
export interface WhatsAppConfig {
  id: string;
  account_id: string;
  /** 034: which vendor connected this number. One row per
   *  (account_id, user_id) — an account can now have several. */
  user_id: string;
